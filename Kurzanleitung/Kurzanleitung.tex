...
\begin{document}
	...
	\begin{center}
		{\LARGE \textbf{Kurzanleitung Ultraschallradar}}\\[0.3em]
...
\begin{enumerate}
	...
	\item Ordner \texttt{BenutzeroberflaecheV2} auf den Computer kopieren (z.\,B. Desktop).
	\item Das korrekte Betriebssystem auswählen.
	\item Dann die Datei \textit{„Benutzeroberflaeche“} per Doppelklick starten.
\end{enumerate}

\subsection{Reihenfolge beim Start}

\begin{enumerate}
	\item \textbf{Hardware anschließen:} Radarsystem über das Micro-USB Kabel mit dem Computer verbinden und Stromversorgung sicherstellen. 
	\item \textbf{Software starten:} Die Benutzeroberfläche aus dem kopierten Ordner starten. 
...
Das System erkennt Objekte zuverlässig in einem Bereich von etwa 2\,cm bis 40\,cm. Über die 40\,cm hinaus wird die Distanz zwar weiterhin in der Text-Statusanzeige aktualisiert, kann jedoch im grafischen Radar-Gitter nicht mehr visualisiert werden.
