...
public class Ultraschallradar_Benutzeroberflaeche_Processing extends PApplet {
...
public void drawRadarScreen() {
  ...
  arc(0, 0, radarRadius * 1.5f, radarRadius * 1.5f, PI, TWO_PI);
  arc(0, 0, radarRadius, radarRadius, PI, TWO_PI);
  arc(0, 0, radarRadius * 0.5f, radarRadius * 0.5f, PI, TWO_PI);
  ...
  text("10cm", 5, -(radarRadius * 0.25f));
  text("20cm", 5, -(radarRadius * 0.5f));
  text("30cm", 5, -(radarRadius * 0.75f));
  ...
  text("Winkel: " + PApplet.parseInt(angle) + "°", 20, 50);
  
  if(distance < maxDistanceCm && distance > 0) {
    text("Distanz: " + PApplet.parseInt(distance) + " cm", 20, 80);
  } else {
    text("Distanz: Außer Reichweite", 20, 80);
  }
}

public void drawTestingScreen() {
  background(30);
  fill(255, 200, 0);
  textAlign(CENTER, CENTER);
  textSize(36);
...
smooth(); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "Ultraschallradar_Benutzeroberflaeche_Processing" };
    if (passedArgs != null) {
