\begin{tikzpicture}[scale=1.6, transform shape, font=\sffamily]
	% Sensor
	\filldraw[fill=gray!30, draw=black, thick] (0,-2) rectangle (1,2);
	\node at (0.5, 0) [rotate=90] {\textbf{Ultraschallsensor}};
	
	% Hindernis
	\filldraw[fill=red!30, draw=red!80!black, thick] (7,-1.5) rectangle (7.5,1.5);
	\node at (7.25, 0) [rotate=-90, text=red!80!black] {\textbf{Objekt}};
