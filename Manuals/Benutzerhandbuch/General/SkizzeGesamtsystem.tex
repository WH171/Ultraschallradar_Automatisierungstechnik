			...
			\begin{scope}[shift={(5,0)}]
				...
				% Öffnungen Hinten (LEDs und USB)
				% USB Port (unten mittig)
				\draw[fill=white, thick, rounded corners=1pt] (1.6, 0.6) rectangle (2.4, 0.9);
				\draw[fill=black!70] (1.7, 0.7) rectangle (2.3, 0.8); 
				
				% LEDs (oben)
				\draw[fill=white, thick] (2.5, 3) circle (0.2); 
				\draw[fill=white, thick] (3, 3) circle (0.2); 
				
				% Dreheinheit (Rückseite)
				\draw[fill=black!15, thick] (1.2, 4) rectangle (2.8, 4.6);
				
				% Ultraschallsensor (Rückseite)
				\draw[fill=black!10, thick] (0.1, 4.4) rectangle (3.9, 5.8);
				...
				\node[label_node] (lblUSB) at (5, 0.75) {Micro-USB Port};
				\draw[arrow] (lblUSB) -- (2.6, 0.75);
				\node[label_node] (lblGeh) at (5.5, 2) {Geh\"ause};
				\draw[arrow] (lblGeh) -- (4, 2);
			\end{scope}
