\begin{tikzpicture}[font=\sffamily, scale=1.2, transform shape]
	% Sensor in der Mitte
	...
	\node[text=green!40!black] at (0, 1.5) {\textbf{Aktiver Messbereich ($0^\circ - 180^\circ$)}};
	\node[text=green!40!black] at (0, 1) {Reichweite: 2\,cm - 40\,cm};
