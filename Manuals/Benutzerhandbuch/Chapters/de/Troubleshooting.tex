...
\begin{itemize}
	...
	\item \textbf{Fehlermeldung:} \textit{,, SYSTEMFEHLER  - Sicherstellen das der Computer mit dem radarsystem verbunden ist!  - Anlage überprüfen und Arduino neustarten.''}
...
\begin{enumerate}
	\item \textbf{Stromversorgung trennen:} Die Anlage stromlos machen (USB-Verbindung zum Computer trennen).
	...
	\item \textbf{Sichtfeld kontrollieren:} Sicherstellen, dass das Sichtfeld des Sensors beim Starten nicht direkt auf 0\,cm blockiert ist.
