...
% $Pfad: UltraschallradarAutomatisierungstechnik/Manuals/Benutzerhandbuch/Chapters/de/SetUp.tex $
% $Version: 1 $
...
\begin{itemize}
	...
	\texttt{Benutzeroberflaeche} herunter.
	...
	\item \textbf{Hinweis:} Bis auf Java ist keine Installation von Drittsoftware oder einer Entwicklungsumgebung  notwendig. Das Programm ist sofort lauffähig.
\end{itemize}
