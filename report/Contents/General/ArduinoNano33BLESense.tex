...
\begin{figure}[h]
	\centering
	\input{tikz/arduinonano33bletikz.tex}
	\caption{Arduino Nano 33 BLE Sense -- Pinbelegung}
	\label{fig:arduino}
\end{figure}
