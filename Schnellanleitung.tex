...
\begin{document}
	...
	\begin{center}
		{\LARGE \textbf{Schnelleinstieg Ultraschallradar}}\\[0.5em]
		{\large (PC gestütztes Ultraschall-Radarsystem)}
	\end{center}
	...
	%\begin{figure}[h]
	%	\centering
	%	\includegraphics[width=0.7\textwidth]{image.jpg} % Dateiname bei dir %anpassen
	%	\caption{Ultraschallradar-System mit Dreheinheit}
	%\end{figure}
	
	\section{Einleitung}
	
	Dieser Schnelleinstieg beschreibt die wichtigsten Schritte, um das Ultraschallradar-System sicher zu starten und zu bedienen.
	...
	\begin{itemize}
		\item Gerät nur an einem standardkonformen Computer-USB-Port (5\,V) betreiben.
	...
	Radarsystem auf eine ebene Fläche (z.\,B. Tisch) stellen.
	Im Umkreis von mindestens 50\,cm dürfen keine Gegenstände die Rotation der Dreheinheit behindern. 
	...
	\begin{enumerate}
		...
		\item Ordner \texttt{Ultraschallradar-Software} auf den Computer kopieren (z.\,B. Desktop).
		\item Im kopierten Ordner die Datei \textit{„Ultraschallradar Benutzeroberfläche App“} per Doppelklick starten.
	\end{enumerate}
	...
	Auf dem Bildschirm erscheint eine kreisförmige Anzeige mit Radar-Gitter und einem Scan-Strahl, der von 0\(^\circ\) bis 180\(^\circ\) und zurück läuft. 
	Erkannte Hindernisse werden als rote Punkte auf dem Gitter dargestellt. 
	...
	Das System erkennt Objekte zuverlässig in einem Bereich von etwa 2\,cm bis 40\,cm. 
	...
	\begin{enumerate}
		\item Radarsystem stromlos machen (USB-Verbindung zum Computer trennen). 
