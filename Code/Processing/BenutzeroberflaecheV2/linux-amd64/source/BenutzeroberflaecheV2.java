...
public class BenutzeroberflaecheV2 extends PApplet {
    ...
    if (platform == WINDOWS) {
      ...
      for (int i = 0; i < ports.length; i++) {
        if (ports[i].toUpperCase().startsWith("COM")) {
          try {
            int comNum = PApplet.parseInt(ports[i].substring(3));
...
public void draw() {
  ...
  text("Winkel: " + PApplet.parseInt(angle) + "°", 45, 100);
  text("Entfernung: " + PApplet.parseInt(distance) + " cm", 45, 130);
}
...
smooth(); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "BenutzeroberflaecheV2" };
    if (passedArgs != null) {
