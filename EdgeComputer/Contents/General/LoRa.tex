...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LORA1.jpg}
		\caption{LoRa}
		\label{LoRAWANRange} 
	\end{center}
\end{figure}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LoRAwanRange.png}
...
The LoRa implementation in the Portenta Vision Shield comprises several essential hardware components (Refer Figure ~\ref{tab:general-specifications}) that work together to enable seamless communication, data handling, and energy management. Below are the key components \cite{ArduinoLora:2025}.
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LORA2.jpg}
...
\begin{itemize}
	\item \textbf{Function:} Serves as the control center for LoRa operations, handling data processing, interfacing with the transceiver, and managing communication protocols \cite{ArduinoLora:2025}.
...
\begin{itemize}
	...
	\item \textbf{Components:} Includes voltage regulators and power management ICs to ensure stable operation of the LoRa transceiver and optimize battery life during transmission \cite{ArduinoLora:2025}.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Configuration:} Communicates with the MCU using I2C, SPI, or UART protocols \cite{ArduinoLora:2025}.
\end{itemize}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item \textbf{SRAM:} 8 MB SDRAM for temporary data processing during LoRa communication \cite{ArduinoLora:2025}.
	\end{enumerate}
\end{itemize}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/TTN1.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LoRaWAN Topology.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/P2P LoRa.png}
		\caption{P2P LoRa}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LoRaWANArch.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/NetworkLayer.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/ClassAProfile.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/ClassBProfile.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/ClassCProfile.png}
...
\begin{enumerate}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/OTAA.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/Activation.png}
...
\begin{itemize}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/ThingsNetwork.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/SelectApplication.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/AddingApplication.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/AppParameter.png}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/MCore.png}
			\caption{MCore}
			\label{MCore}
		\end{center}
	\end{figure}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=0.7\linewidth]{Arduino/LoRa/UploadCode.png}
			\caption{UploadCode}
	...
	\begin{lstlisting}[language=C++, frame=single, numbers=left, basicstyle=\ttfamily\small]
		...
		\begin{figure}
			\begin{center}
				\includegraphics[width=0.7\linewidth]{Arduino/LoRa/RegisteringDevice.png}
		...
		\begin{figure}
			\begin{center}
				\includegraphics[width=0.7\linewidth]{Arduino/LoRa/DeviceEUI.png}
				\caption{RegisteringDevice}
				\label{RegisteringDevice} 
			\end{center}
		\end{figure}
		...
		\begin{figure}
			\begin{center}
				\includegraphics[width=0.7\linewidth]{Arduino/LoRa/Secondstep.png}
				\caption{Secondstep}
				\label{Secondstep} 
			\end{center}
		\end{figure}
		...
		\begin{figure}
			\begin{center}
				\includegraphics[width=0.7\linewidth]{Arduino/LoRa/TTN.png}
				\caption{TTN}
				\label{TTN} 
			\end{center}
		\end{figure}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/InstallMKRWAN.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/MKRWANStandalone.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/SerialMonitor.png}
...
\subsubsection{Connecting to TTN} Once your board has been registered you can send information to TTN. Let's come back to the Serial Monitor and proceed. It will ask for: (Refer figure ~\ref{Select-board-h7})
		...
		\begin{figure}
			\begin{center}
				\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LoraConnection.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LoRAConnectivity.png}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Arduino/LoRa/LCommunication.png}
