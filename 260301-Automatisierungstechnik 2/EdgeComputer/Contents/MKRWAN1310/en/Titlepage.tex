...
% $Pfad: Contents/MKRWAN1310/Titlepage.tex $
% $Version: 1785 $
%
%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{titlepage}
	...
	{\hspace{-50mm}%\vspace{-30mm}
		\begin{tikzpicture}
			...
			\node[white,right] (Title) at (3,1) {\Huge \textsf{\TRANS{LoRaWan mit dem Arduino MKR WAN 1310}{LoRaWan with an Arduino MKR WAN 1310}}};
			\node[white,right] (Title) at (3,0) {\LARGE \textsf{\TRANS{Systembeschreibung}{System Description}}};
