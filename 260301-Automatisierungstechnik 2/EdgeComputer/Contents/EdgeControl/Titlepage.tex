...
% $Pfad: komponenten/Bilderkennung/Produktspezifikation/MAX78000/Titlepage.tex $
% $Version: 1765 $
%
%%%%%%%%%%%%%%%%%%%%%%%%
...
\definecolor{greenyellow}{rgb}{0.83,0.75,0.03}

\definecolor{lightgreen}{rgb}{0.1,1,0.1}
...
\begin{titlepage}
	...
	{\hspace{-50mm}\vspace{-10mm}\includegraphics[width=220mm,height=80mm]{Allgemein/LogoDataScienceLightGreen}};
	...
	{\hspace{-50mm}%\vspace{-30mm}
		\begin{tikzpicture}
			\draw[lightgreen,fill] (0,-1) -- (0,2) -- (80,2) -- (80,-1) -- cycle;
			
			
			\node[black,right] (Name) at (3,3) {\Huge \textsf{Elmar Wings}};
			\node[black,right] (Title) at (3,1) {\Huge \textsf{\TRANS{Urban Gardening}{Urban Gardening}}};
			\node[black,right] (Title) at (3,0) {\LARGE \textsf{\TRANS{Using Edge Control, MKRWan 1310 and Nesso N1}{Using Edge Control, MKRWan 1310 and Nesso N1}}};
